...
<body>
    <div id="app">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                   <button class="btn btn-secondary">{{ __('Logout') }}</button>
                                </a>
                            </li>
        ...
        <footer class="main-footer">
            <a href="https://www.linkedin.com/in/davidfernandosandovalgomez" title="" target="_blank">David Sandoval</a> | Copyright © {{ date('Y') }}
        </footer>
    </div>
</body>
</html>
